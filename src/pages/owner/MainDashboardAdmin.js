...
import { FaHouseUser,FaDatabase, FaShoppingBag, FaBandcamp } from "react-icons/fa";
      ...
      <div className="col-md-12 col-lg-6">
       ...
       <div className="col-md-6">
        <div className="widget-small primary coloured-icon">
            <div className='iicon'>
                <i className='icon'><FaHouseUser/></i>
            </div>
          <div className="info">
          ...
          <div className="col-md-6">
            <div className="widget-small warning coloured-icon">
                <div className='iicon'>
                <i className='icon'><FaShoppingBag/></i>
                </div>
              <div className="info">
                <h4>Tổng đơn hàng</h4>
